...
double precision floating point types, between ±7.98e28. Decimal literals are
denoted with the `m` suffix.

[1]: https://learn.microsoft.com/dotnet/csharp/language-reference/builtin-types/floating-point-numeric-types
